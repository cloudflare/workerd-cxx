...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "cc": Label("@vendor//:cc-1.2.20"),
            "clap": Label("@vendor//:clap-4.5.33"),
            ...
            "static_assertions": Label("@vendor//:static_assertions-1.1.0"),
            "syn": Label("@vendor//:syn-2.0.100"),
            "trybuild": Label("@vendor//:trybuild-1.0.110"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.cc-1.2.20.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__clap-4.5.33",
        sha256 = "e2c80cae4c3350dd8f1272c73e83baff9a6ba550b8bfbe651b3c45b78cd1751e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap/4.5.33/download"],
        strip_prefix = "clap-4.5.33",
        build_file = Label("//third-party/bazel:BUILD.clap-4.5.33.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__clap_builder-4.5.33",
        sha256 = "0123e386f691c90aa228219b5b1ee72d465e8e231c79e9c82324f016a62a741c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap_builder/4.5.33/download"],
        strip_prefix = "clap_builder-4.5.33",
        build_file = Label("//third-party/bazel:BUILD.clap_builder-4.5.33.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__clap_derive-4.5.32",
        ...
        build_file = Label("//third-party/bazel:BUILD.clap_derive-4.5.32.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-channel-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-channel-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-core-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-core-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-executor-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-executor-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-io-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-io-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-macro-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-macro-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-sink-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-sink-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-task-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-task-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__futures-util-0.3.31",
        ...
        build_file = Label("//third-party/bazel:BUILD.futures-util-0.3.31.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__glob-0.3.3",
        ...
        build_file = Label("//third-party/bazel:BUILD.glob-0.3.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.heck-0.5.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.memchr-2.7.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.pin-project-lite-0.2.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.pin-utils-0.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.ryu-1.0.20.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "vendor__serde_json-1.0.142",
        ...
        build_file = Label("//third-party/bazel:BUILD.serde_json-1.0.142.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__serde_spanned-1.0.0",
        ...
        build_file = Label("//third-party/bazel:BUILD.serde_spanned-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.slab-0.4.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.static_assertions-1.1.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "vendor__target-triple-0.1.4",
        ...
        build_file = Label("//third-party/bazel:BUILD.target-triple-0.1.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.toml-0.9.5.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__toml_datetime-0.7.0",
        ...
        build_file = Label("//third-party/bazel:BUILD.toml_datetime-0.7.0.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__toml_parser-1.0.2",
        ...
        build_file = Label("//third-party/bazel:BUILD.toml_parser-1.0.2.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__toml_writer-1.0.2",
        ...
        build_file = Label("//third-party/bazel:BUILD.toml_writer-1.0.2.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__trybuild-1.0.110",
        sha256 = "32e257d7246e7a9fd015fb0b28b330a8d4142151a33f03e6a497754f4b1f6a8e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/trybuild/1.0.110/download"],
        strip_prefix = "trybuild-1.0.110",
        build_file = Label("//third-party/bazel:BUILD.trybuild-1.0.110.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.winnow-0.7.12.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "vendor__static_assertions-1.1.0", is_dev_dep = False),
        struct(repo = "vendor__syn-2.0.100", is_dev_dep = False),
        struct(repo = "vendor__trybuild-1.0.110", is_dev_dep = False),
    ]
