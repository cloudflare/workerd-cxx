...
pub mod bridge {
    ...
    extern "Rust" {
        ...
        fn try_get_length(self: &RustAsyncInputStream) -> Maybe<usize>;
        ...
        fn try_get_length(self: &RustAsyncIoStream) -> Maybe<usize>;
    ...
    unsafe extern "C++" {
        ...
        #[must_use]
        fn try_get_length(self: Pin<&mut CxxAsyncInputStream>) -> Maybe<usize>;
        ...
        #[must_use]
        fn try_get_length(self: Pin<&mut CxxAsyncIoStream>) -> Maybe<usize>;
...
impl RustAsyncInputStream {
    ...
    #[must_use]
    pub fn try_get_length(&self) -> Maybe<usize> {
