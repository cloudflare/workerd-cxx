...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        type CxxAsyncOutputStream = io::ffi::CxxAsyncOutputStream;
        type CxxAsyncIoStream = io::ffi::CxxAsyncIoStream;
    }
    ...
    extern "Rust" {
        ...
        // fn create_rust_mock_input_stream_with_error() -> Box<RustAsyncInputStream>;
...
pub async unsafe fn generate_prng_ffi<'a>(
    ...
    let mut wrapper = io::CxxAsyncOutputStream::new(stream);
...
#[must_use]
pub fn create_rust_mock_output_stream() -> Box<io::RustAsyncOutputStream> {
    let mock_stream = MockOutputStream::new();
    Box::new(io::RustAsyncOutputStream::new(mock_stream))
}

/// Create a Rust `MockOutputStream` that returns write errors
#[must_use]
pub fn create_rust_mock_output_stream_with_error() -> Box<io::RustAsyncOutputStream> {
...
/// Create a Rust `MockIoStream` with given input data
#[must_use]
pub fn create_rust_mock_io_stream(input_data: &[u8]) -> Box<io::RustAsyncIoStream> {
    let mock_stream = MockIoStream::new(input_data.to_vec());
    Box::new(io::RustAsyncIoStream::new(mock_stream))
}

/// Create a Rust `MockInputStream` that returns read errors
#[must_use]
pub fn create_rust_mock_input_stream_with_error() -> Box<io::RustAsyncInputStream> {
    let mock_stream = MockInputStream::new(Vec::new()).with_error();
    Box::new(io::RustAsyncInputStream::new(mock_stream))
}
...
#[must_use]
pub fn get_mock_output_stream_data(_stream: &io::RustAsyncOutputStream) -> Vec<u8> {
...
pub async unsafe fn compute_stream_hash_iostream_ffi(
    stream: &mut io::RustAsyncIoStream,
) -> Result<u64> {
    const FNV_OFFSET_BASIS: u64 = 14_695_981_039_346_656_037;
    const FNV_PRIME: u64 = 1_099_511_628_211;
