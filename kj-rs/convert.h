...
/// kjArrayPtr.as<Rust>()
template <typename T>
inline ::rust::Slice<const T> into(Rust, const kj::ArrayPtr<T>* arr) {
  return ::rust::Slice<const T>(arr->begin(), arr->size());
}

/// kjArray.as<Rust>()
template <typename T>
inline ::rust::Slice<const T> into(Rust, const kj::Array<T>* arr) {
  return ::rust::Slice<const T>(arr->begin(), arr->size());
}

/// kjString.as<Rust>()
inline ::rust::Slice<const char> into(Rust, const kj::String* str) {
  return ::rust::Slice(str->begin(), str->size());
}

/// kjStringPtr.as<Rust>()
inline ::rust::Slice<const char> into(Rust, const kj::StringPtr* str) {
  return ::rust::Slice(str->begin(), str->size());
}

/// kjConstString.as<Rust>()
inline ::rust::Slice<const char> into(Rust, const kj::ConstString* str) {
  return ::rust::Slice(str->begin(), str->size());
}
...
template <typename T>
static ::rust::Vec<T> into(RustCopy, kj::ArrayPtr<const T>* arr) {
  ::rust::Vec<T> result;
...
inline ::rust::Vec<char> into(RustCopy, const kj::StringPtr* str) {
  auto ptr = str->asArray();
  return into(RustCopy{}, &ptr);
}

/// kjConstString.as<RustCopy>()
inline ::rust::Vec<char> into(RustCopy, const kj::ConstString* str) {
  auto ptr = str->asArray();
  return into(RustCopy{}, &ptr);
}
...
template <typename T>
inline ::rust::Slice<T> into(RustMutable, kj::ArrayPtr<T>* arr) {
  return ::rust::Slice<T>(arr->begin(), arr->size());
}

/// kjArray.as<RustMutable>()
template <typename T>
inline ::rust::Slice<T> into(RustMutable, kj::Array<T>* arr) {
  return ::rust::Slice<T>(arr->begin(), arr->size());
}
...
inline ::rust::String into(RustUncheckedUtf8, const kj::String* str) {
  return ::rust::String(str->begin(), str->size());
}

/// kjStringPtr.as<RustUncheckedUtf8>()
inline ::rust::Str into(RustUncheckedUtf8, const kj::StringPtr* str) {
  return ::rust::Str(str->begin(), str->size());
}

/// kjConstString.as<RustUncheckedUtf8>()
inline ::rust::Str into(RustUncheckedUtf8, const kj::ConstString* str) {
  return ::rust::Str(str->begin(), str->size());
}
...
inline ::rust::String into(RustCopyUncheckedUtf8, const kj::StringPtr* str) {
  return ::rust::String(str->begin(), str->size());
}

/// kjConstString.as<RustCopyUncheckedUtf8>()
inline ::rust::String into(RustCopyUncheckedUtf8, const kj::ConstString* str) {
  return ::rust::String(str->begin(), str->size());
}
