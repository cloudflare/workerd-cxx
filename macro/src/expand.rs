    ...
    quote_spanned! {end_span=>
        ...
        #unsafe_token impl ::kj_rs::repr::Refcounted for #ident {
            fn is_shared(&self) -> bool {
                #UnsafeExtern extern "C" {
                    #[link_name = #is_shared]
                    fn __is_shared(ptr: *const ::cxx::core::ffi::c_void) -> bool;
                }
                unsafe {
                    __is_shared(self as *const #ident as *const ::cxx::core::ffi::c_void)
                }
            }
            fn add_ref(rc: &::kj_rs::repr::KjRc<#ident>) -> ::kj_rs::repr::KjRc<#ident> {
                #UnsafeExtern extern "C" {
                    #[link_name = #add_ref]
                    fn __add_ref(refcounted: *const ::kj_rs::repr::KjRc<#ident>, ptr: *const ::kj_rs::repr::KjRc<#ident>) -> bool;
                }
...
fn expand_kj_arc(key: NamedImplKey, types: &Types, explicit_impl: Option<&Impl>) -> TokenStream {
    ...
    quote_spanned! {end_span=>
        ...
        #unsafe_token impl ::kj_rs::repr::AtomicRefcounted for #ident {
            ...
            fn add_ref(arc: &::kj_rs::repr::KjArc<#ident>) -> ::kj_rs::repr::KjArc<#ident> {
                #UnsafeExtern extern "C" {
                    #[link_name = #add_ref]
                    fn __add_ref(refcounted: *const ::kj_rs::repr::KjArc<#ident>, ptr: *const ::kj_rs::repr::KjArc<#ident>) -> bool;
                }
                let mut ret = ::cxx::core::mem::MaybeUninit::uninit();
                unsafe {
