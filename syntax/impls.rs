...
impl Hash for Type {
    fn hash<H: Hasher>(&self, state: &mut H) {
        ...
        match self {
            ...
            Type::NonNull(t) => t.hash(state),
            Type::KjMaybe(t) => t.hash(state),
...
impl PartialEq for Type {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Type::KjOwn(lhs), Type::KjOwn(rhs)) => lhs == rhs,
            ...
            (Type::NonNull(lhs), Type::NonNull(rhs)) => lhs == rhs,
